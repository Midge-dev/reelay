...
const _badgeBorder = Border.fromBorderSide(BorderSide(color: AppColors.warning));
              ...
              children: [
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      AppText('Jellyfin', style: AppTypography.label, color: AppColors.ink2),
                      SizedBox(height: 3),
                      AppText('Not connectable yet', style: AppTypography.caption, color: AppColors.ink3),
                    ],
                  ),
                ),
                const SizedBox(width: AppSpacing.lg),
                Container(
                  ...
                  decoration: BoxDecoration(border: _badgeBorder, borderRadius: BorderRadius.circular(AppShape.radiusSm)),
                  child: const AppText('COMING SOON', style: AppTypography.caption, color: AppColors.warning),
                ),
              ],
            ),
          ),
